  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ color: theme.palette.text.primary }}>Explore Our</span>{" "}
          3D Design{" "}
          <span style={{ color: theme.palette.text.primary }}>Services</span>
        </Typography>
        <Typography variant="body1" textAlign="center">
          Bring your imagination to life with our cutting-edge 3D design
          services. Whether you're envisioning modern office interiors, cozy
          café designs, or striking architectural layouts, we provide innovative
          solutions tailored to your needs. From concept to execution, our
          expertise ensures your space reflects elegance, functionality, and
          style.
        </Typography>
      </Box>
      <Slider {...settings}>
